...
import static com.kobiton.scriptlessautomation.Config.runner;
...
//
   ...
   public WebElement findElementBy(WebElement rootElement, int timeoutInMiliSeconds, By... locators) throws Exception {
       List<WebElement> foundElements = findElements(rootElement, timeoutInMiliSeconds, false, locators);
...
//     */
    public void touchOnElementByType(WebElement element, double relativePointX, double relativePointY) throws Exception {
...
//     */
    public TouchAction touchAtRelativePointOfElement(WebElement element, double relativePointX, double relativePointY) throws IOException {
        ...
        return touchAtPoint(getAbsolutePoint(relativePointX, relativePointY));
    }

    /**
     * Touch at a relative positioneyes.check("Delete Single Stock Quote", Target.window());
     */
